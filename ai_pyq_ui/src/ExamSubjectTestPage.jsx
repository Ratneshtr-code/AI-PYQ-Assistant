...
export default function ExamSubjectTestPage() {
    ...
    // Fetch exam sets - Subject tests only, filtered by exam
    useEffect(() => {
        const fetchExamSets = async () => {
            try {
                ...
                // Filter: Only show exam_type === "subject_test" and has subject
                const filtered = data.filter(set => 
                    set.exam_type === "subject_test" && set.subject
                );
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">
                                    {decodedExamName} {language === "hi" ? "विषय-वार टेस्ट" : "Subject-wise Tests"}
                                </h1>
                                <p className="text-xs md:text-sm text-gray-600">
                                    {language === "hi"
                                        ? "विषय-वार अभ्यास टेस्ट"
                                                ...
                                                <div className="p-5">
                                                    ...
                                                    {examSet.subject && (
                                                        <p className="text-sm text-gray-600 mb-4">
                                                            <span className="font-semibold">{language === "hi" ? "विषय:" : "Subject:"}</span> {examSet.subject}
                                                        </p>
                                                    )}
