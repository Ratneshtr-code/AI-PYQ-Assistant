...
export default function ExamPYQPage() {
    ...
    // Fetch exam sets - PYQ tests only, filtered by exam
    useEffect(() => {
        const fetchExamSets = async () => {
            try {
                ...
                // Filter: Only show exam_type === "pyp" and no subject (full papers)
                const filtered = data.filter(set => 
                    set.exam_type === "pyp" && !set.subject
                );
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">
                                    {decodedExamName} {language === "hi" ? "PYQ" : "PYQ Tests"}
                                </h1>
